...
CREATE TABLE `termine` (
  ...
  `Wecker_Zeit` date DEFAULT NULL,
  `Wecker_Aktiv` char(1) NOT NULL,
  PRIMARY KEY (`ID_Termine`),
  KEY `ID_Anliegen` (`ID_Anliegen`),
  CONSTRAINT `termine_ibfk_1` FOREIGN KEY (`ID_Anliegen`) REFERENCES `anliegen` (`ID_Anliegen`)
...
INSERT INTO `termine` VALUES (1,1,'2018-01-05','2018-01-10','2018-01-01','1');
...
-- Dump completed on 2019-01-07 13:55:51
