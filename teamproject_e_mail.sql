...
CREATE TABLE `e_mail` (
  ...
  `Inhalt` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`ID_Mail`),
  KEY `Matrikelnummer` (`Matrikelnummer`),
  CONSTRAINT `e_mail_ibfk_1` FOREIGN KEY (`Matrikelnummer`) REFERENCES `student` (`Matrikelnummer`)
...
INSERT INTO `e_mail` VALUES (1,123456,'Hallo Welt!');
